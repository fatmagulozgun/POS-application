    ...
    useEffect(() => {
        const getCategories = async () => {
            try {
                ...
                console.log("Kategoriler API sonucu:", data); // LOG
                data &&
                    setCategories(
                        data.map((item) => {
                ...
                console.log("Kategori API hatası:", error); // LOG
            }
        };
    ...
    useEffect(() => {
        const getProducts = async () => {
            try {
                ...
                const data = await res.json();
                console.log("Ürünler API sonucu:", data); // LOG
                setProducts(data);
            } catch (error) {
                console.log("Ürün API hatası:", error); // LOG
            }
        };
